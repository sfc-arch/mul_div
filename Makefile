...
OBJS9 = mul_div_ryota-iso_v2.o
CFLAGS = -Wall -O0
CC = gcc
INCLUDE =

all: mul_div mul_div_macchan mul_div_junpei mul_div_kota mul_div_ryota-iso mul_div_hotaka mul_div_kemuniku mul_div_fumi mul_div_ryota-iso_v2
...
mul_div_tyota-iso_v2: ${OBJS8}
	${CC} ${CFLAGS} ${INCLUDES} -o $@ ${OBJS8} ${LIBS}

clean:
	-rm -f *.o mul_div mul_div_macchan mul_div_junpei mul_div_kota mul_div_ryota-iso mul_div_hotaka mul_div_kemuniku mul_div_fumi mul_div_ryota-iso_v2
